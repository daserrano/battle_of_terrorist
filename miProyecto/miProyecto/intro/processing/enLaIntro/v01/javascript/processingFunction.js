...
if (rectOverCuadroConfirmacion2 && personaje >= 5 && confirmado == true && rectDone2 == true && color != undefined){
...
//if (rectOverColorRed && personaje != undefined || (personaje1 == undefined && personaj)) {
if (rectOverColorRed && personaje != undefined) {
  color = "rojo";
  //dime(personaje,color);
}
if (rectOverColorBlue && personaje != undefined) {
  color = "azul";
  //dime(personaje,color);
}
if (rectOverColorGreen && personaje != undefined) {
  color = "verde";
  //dime(personaje,color);
}
}
